...
为提升《见声看见》和《见声听力测试》产品及/或服务的使用体验和便利程度，《见声看见》和《见声听力测试》可能会通过调用设备权限的方式收集您的如下个人信息。如果您不同意提供这些个人信息，您可能无法使用《见声看见》和《见声听力测试》产品及/或服务的功能，《见声看见》和《见声听力测试》通过调用设备权限收集的个人信息包括设备位置、“访问您设备上的照片、媒体内容和文件”、录制音频等。
...
您的账号信息。如果您希望访问或修改您在《见声看见》和《见声听力测试》产品及/或服务中的账号信息，包括头像、昵称、性别、生日、地区信息、手机号码等实名验证信息、账号密码等，您可以通过访问《见声看见》和《见声听力测试》产品及/或服务进行操作。
